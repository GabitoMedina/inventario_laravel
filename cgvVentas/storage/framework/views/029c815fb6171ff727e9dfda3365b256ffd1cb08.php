    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg"><b>CGV-Solutions</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(route('cgv.articulo.index')); ?>"><i class="fa fa-circle-o"></i> Artículos</a></li>
                <li><a href="<?php echo e(route('cgv.categoria.index')); ?>"><i class="fa fa-circle-o"></i> Categorías</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo e(route ('compras.ingreso.index')); ?>"><i class="fa fa-circle-o"></i> Ingresos</a></li>
                <li><a href="<?php echo e(route ('compras.proveedor.index')); ?>"><i class="fa fa-circle-o"></i> Proveedores</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(route ('ventas.cliente.index')); ?>"><i class="fa fa-circle-o"></i> Clientes</a></li>
              </ul>
            </li>
