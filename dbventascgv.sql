...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-05-2018 a las 11:42:05
...
CREATE TABLE `caracteristicas_servicio` (
  ...
  `obsrvacion` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `servicio` (
  ...
  `costo_chequeo` decimal(11,0) NOT NULL,
  `abono` decimal(11,0) NOT NULL,
  `saldo` decimal(11,0) NOT NULL,
  `total_servicio` decimal(11,0) NOT NULL,
